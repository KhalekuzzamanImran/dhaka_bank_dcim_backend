...
def generate_report_job(report_job_id):
    # Legacy compatibility wrapper kept in place while the registry-based
    # generation service becomes the authoritative path.
    from .execution import generate_report_job as _generate_report_job

    return _generate_report_job(report_job_id)
